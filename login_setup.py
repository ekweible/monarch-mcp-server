...
Run this script to authenticate and save a token for the MCP server to use.
"""
...
async def main():
    ...
    print("=" * 45)
    print("This will authenticate you once and save a token")
    ...
    try:
        ...
        try:
            ...
            if login_method == "2":
                print("Get a fresh browser token and run login_setup.py again.")
                return
            ...
            if (
                ...
                print(
                    "Try updating the library: pip install --upgrade monarchmoneycommunity"
                )
                return
        ...
        try:
            ...
            print(
                "Enable MONARCH_ALLOW_PLAINTEXT_TOKEN_STORAGE=true only if you "
                "explicitly accept unencrypted file storage."
            )
            return
